...
public class MenuUtil {
    ...
    public static List<MenuTo> getTosFetchDishes(List<Menu> menus, DishRepository repository) {
        return menus.stream()
                .map(menu -> getToFetchDishes(menu, repository))
                .toList();
    }

    public static MenuTo getToFetchDishes(Menu menu, DishRepository repository) {
